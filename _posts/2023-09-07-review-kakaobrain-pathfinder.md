...
만약 패스파인더 프로그램이 단순한 AI 서비스 완성에만 목표를 두었다면 별 문제가 없었겠지만, 앞서 언급했던 것처럼 시장성이 굉장히 중요한 요소였기 때문에 유저 환경을 배재할 수 없었습니다. 따라서 저는 최근 Kotlin 진영에서 활발히 발전하고 있는 **Kotlin Multiplatform 기술을 사용해 데스크탑 앱을 개발**하는 것을 팀원들에게 제안했습니다.
