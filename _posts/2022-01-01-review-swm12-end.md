...
나는 나에게 정말 과분한 팀원들을 만났지만, 더 좋은 추억을 만들고 최선의 팀이 되도록 하지 못한 내 자신이 후회된다.

> **당장 내가 짠 스파게티 코드보다, 내 눈 앞의 팀원 마음이 더 읽기 어렵다**
...
**개발적인 지식에 있어서는 수직 상승**이라고 해도 과언이 아니다. 단순히 내가 이번 프로젝트에서 다뤘던 프레임워크에 대한 지식을 늘린 것이 전부가 아니다. **프로젝트의 기획부터 팀원들과의 협업, 프론트엔드와 백엔드의 역할과 서로 간의 소통, 프레젠테이션을 통한 프로젝트 내용 전달, 그리고 실서비스로의 배포와 마케팅**까지 전반적인 내용을 결코 얕지 않고 깊게 배울 수 있는 기회였다. 거기에 더해 **개발 외적인 부분**에 대해서도 많은 것을 깨닫고 배울 수 있었다. 또 내 이름으로 SW 특허도 내보고, 본 과정 이후에 진행된 고도화 과정에서는 교육을 통해 AWS 자격증을 취득할 수도 있었다.
